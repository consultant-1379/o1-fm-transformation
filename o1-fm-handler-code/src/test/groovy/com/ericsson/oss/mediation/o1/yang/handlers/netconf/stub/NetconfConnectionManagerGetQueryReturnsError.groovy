...
class NetconfConnectionManagerGetQueryReturnsError implements NetconfOperationConnection, NetconfManager {

    @Override
    public NetconfOperationResult executeXAResourceOperation(NetconfOperationRequest netconfOperationRequest) {
        return null;
    }
    ...
    public NetconfResponse get(Filter filter) throws NetconfManagerException {
        String errorData = "Error no data for query";
        NetconfResponse response = new NetconfResponse();
        response.setError(Boolean.TRUE);
        response.setErrorMessage(errorData);
        return response;
    }
    ...
    @Override
    public NetconfResponse get(NetconfResponseListener netconfResponseListener, Datastore datastore, Filter filter, String s)
    ...
    @Override
    public NetconfResponse getConfig(NetconfResponseListener netconfResponseListener, Datastore datastore, Filter filter)
            throws NetconfManagerException {
        return null;
    }
    ...
    @Override
    public NetconfResponse editConfig(Datastore datastore, DefaultOperation defaultOperation, ErrorOption errorOption, TestOption testOption,
                                      String s) throws NetconfManagerException {
        return null;
    }
