...
import com.ericsson.oss.mediation.adapter.netconf.jca.xa.yang.provider.YangNetconfOperationResult.YangNetconfOperationResultCode;
...
/**
 * Stub to replace {@code NetconfManager} in tests.
 * <p>
 * The {@code NetconfManager} is the resource adaptor that is used to send netconf requests to the network element.
 */
public class NetconfConnectionManagerForTestsOk implements NetconfOperationConnection, NetconfManager {
    ...
    public void setNetconfOperationResult(final Object response, final YangNetconfOperationResultCode code) {
        netconfOperationResult = new YangNetconfOperationResult(response, code);
    }
