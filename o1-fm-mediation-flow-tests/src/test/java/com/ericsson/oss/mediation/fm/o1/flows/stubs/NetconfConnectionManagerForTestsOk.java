...
public class NetconfConnectionManagerForTestsOk implements NetconfOperationConnection, NetconfManager, NetconfSession {

    private NetconfOperationResult netconfOperationResult;

    public NetconfConnectionManagerForTestsOk() {
