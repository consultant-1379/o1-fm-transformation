...
package com.ericsson.oss.mediation.fm.o1.flows.stubs;
...
import com.ericsson.oss.mediation.adapter.netconf.jca.api.subscriber.NetconfSessionSubscriber;
import com.ericsson.oss.mediation.adapter.netconf.jca.api.task.NetconfSessionPeriodicTaskHandler;
...
public class NetconfConnectionManagerForTestsFail implements NetconfOperationConnection, NetconfManager, NetconfSession {

    private NetconfOperationResult netconfOperationResult;

    public NetconfConnectionManagerForTestsFail() {
        netconfOperationResult = YangNetconfOperationResult.OK;
    }
    ...
    public NetconfConnectionStatus getStatus() {
        return NetconfConnectionStatus.CONNECTED;
    }
    ...
    public NetconfResponse editConfig(final Datastore datastore, final DefaultOperation defaultOperation, final ErrorOption errorOption,
            final TestOption testOption, final String s) throws NetconfManagerException {
        return null;
    }
    ...
    @Override
    public void closeSessionHandle() {

    }

    @Override
    public void destroySessionHandle() {

    }

    @Override
    public void setInboundNotificationAdditionalInfo(Serializable serializable) {

    }

    @Override
    public void enableNotificationSubscriber(NetconfSessionSubscriber netconfSessionSubscriber) {

    }

    @Override
    public void disableNotificationSubscriber(NetconfSessionSubscriber netconfSessionSubscriber) {

    }

    @Override
    public void enablePeriodicTask(NetconfSessionPeriodicTaskHandler netconfSessionPeriodicTaskHandler)
            throws IllegalArgumentException, IllegalAccessException {

    }

    @Override
    public void disablePeriodicTask(NetconfSessionPeriodicTaskHandler netconfSessionPeriodicTaskHandler) {

    }

    @Override
    public void disablePeriodicTasks() {

    }

    @Override
    public String dumpSessionInfo() {
        return null;
    }

    @Override
    public String dumpSessionsInfo() {
        return null;
    }

    @Override
    public String dumpConnectionsRegistry() {
        return null;
    }

    @Override
    public String dumpPeriodicTasksRegistry() {
        return null;
    }

    @Override
    public String dumpSubscribersRegistry() {
        return null;
    }
}
